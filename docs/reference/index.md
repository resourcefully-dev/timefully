...
- [`complete_timeseries_datetime()`](https://resourcefully-dev.github.io/timefully/reference/complete_timeseries_datetime.md)
...
- [`format_datetime_axis()`](https://resourcefully-dev.github.io/timefully/reference/format_datetime_axis.md)
